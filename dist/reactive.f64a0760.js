...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"reactive.js":[function(require,module,exports) {
"use strict";
...
var currentData = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            return _context.abrupt("return", data.text.replace(/\\/gi, ''));
...
var currentDOM = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.t0 = "<section><p>";
            _context2.next = 3;
            return currentData();

          case 3:
            _context2.t1 = _context2.sent;
            return _context2.abrupt("return", _context2.t0.concat.call(_context2.t0, _context2.t1, "</p></section>"));
  ...
  return regeneratorRuntime.wrap(function _callee3$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 2:
          return _context3.abrupt("return", document.getElementById('root').innerHTML = _context3.sent);
...
var observer = {
  next: function next(observableInstance) {
    var _this = this;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              console.log("count is ".concat(observableInstance.count)); // move root data into previous

              document.getElementById('previous').innerHTML = "<section><div>previous data:</div><p>".concat(document.getElementById('root').querySelector('p').innerHTML, "</p></section>"); // update root data

              _context4.t0 = "<section><div>new data available!</div><p>";
              _context4.next = 7;
              return currentData();

            case 7:
              _context4.t1 = _context4.sent;
              document.getElementById('root').innerHTML = _context4.t0.concat.call(_context4.t0, _context4.t1, "</p></section>");
  ...
  complete: function complete(observableInstance) {
...
var newObservable = new Observable(function (subscriber) {
  var myInterval = function myInterval() {
    // if subscriber has unsubbed, clear the tick fn
    if (!subscriber.isObserving) {
      return clearInterval(_this2);
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","reactive.js"], null)
//# sourceMappingURL=/reactive.f64a0760.js.map